...
const SolutionSection = () => {
  return (
    <section className="py-16 md:py-24 bg-dark-premium" id="solution">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-muted-foreground font-body text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
          Apresentamos o <strong className="text-foreground">Guia Páscoa Lucrativa</strong>: O Manual Definitivo e Prático para 2026. Um guia direto ao ponto, com <strong className="text-gold">Mega Prompts prontos</strong> para copiar e colar no ChatGPT ou Gemini.
        </p>
